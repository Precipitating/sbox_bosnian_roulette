...
//	public Texture crt_mask;
	...
	/// </summary>
	[Property, Title("Softness"), Range( 0.0f, 10.0f)]
	...
	/// </summary>
	[Property, Title("Flicker Opacity"), Group("Flicker"), Range( 0.0f, 1.0f)]
	public float fOpacity { get; set; }	= 0.02f; 
	
	/// <summary>
	/// How often the screen flickers. Gets weird at high values.
	/// </summary>
	[Property, Title("Flicker Rate"),  Group("Flicker"), Range( 0.0f, 100.0f)]
	...
	/// </summary>
	[Property, Title("Line Count"),  Group("ScanLines"), Range( 0.0f, 1000.0f), Step(1)]
	public float slCount { get; set; }	= 480.0f; 
	
	/// <summary>
	/// How dark the scanlines are.
	/// </summary>
	[Property, Title("Line Opacity"),  Group("ScanLines"), Range( 0.0f, 1.0f)]
	...
	/// </summary>
	[Property, Title("Scroll Rate"),  Group("ScanLines"), Range( -100.0f, 100.0f)]
    ...
    protected override void OnEnabled()
    {
		...
		commands = new CommandList( "CCSCRT" );

		RenderEffect();
		if ( fPriority )
			cc.AddCommandList( commands, Stage.AfterUI );
		else
			cc.AddCommandList( commands, Stage.AfterTransparent );
...
//		attributes.Set( "crt_mask", crt_mask ); //enable later for texture based masks
       ...
       // Graphics.GrabDepthTexture( "DepthBuffer", attributes );
        commands.Blit( Material.Load( "materials/postprocess/ccs_crt.vmat" ), attributes );
